...
function FilesView() {
    const { downloadFilesAndFolders, updateDirectory, clearPersistedData } = useFileSystem()
    ...
    return (
        ...
        >
            ...
            >
                ...
                <button
                    className="flex w-full justify-start rounded-md p-2 transition-all hover:bg-darkHover text-red-400 hover:text-red-300"
                    onClick={clearPersistedData}
                    title="Clear all files and reset workspace"
                >
                    <MdClear className="mr-2" size={22} /> Clear Workspace
                </button>
            </div>
        </div>
    )
